<div class="page-content page-anim" id="page-absensi-harian" style="display:none">
    ...
    <div class="table-card">
        <div class="table-header absensi-table-header" style="background:#f8fafc;border-bottom:2px solid var(--border);padding:14px 20px;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
