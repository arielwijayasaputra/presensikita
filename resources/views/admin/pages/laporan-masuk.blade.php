...
<div class="page-content page-anim" id="page-laporan-masuk" style="display:none">
    ...
    <div class="stat-cards" style="display:grid;grid-template-columns:repeat(5,1fr);gap:14px;margin-bottom:22px">
        {{-- Total --}}
        <div class="stat-card" style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:16px;display:flex;align-items:center;gap:14px">
        ...
        {{-- Menunggu --}}
        <div class="stat-card" style="background:#fffbeb;border:1px solid #fef3c7;border-radius:14px;padding:16px;display:flex;align-items:center;gap:14px">
        ...
        {{-- Diterima & Diproses --}}
        <div class="stat-card" style="background:#eff6ff;border:1px solid #dbeafe;border-radius:14px;padding:16px;display:flex;align-items:center;gap:14px">
        ...
        {{-- Selesai --}}
        <div class="stat-card" style="background:#f0fdf4;border:1px solid #dcfce7;border-radius:14px;padding:16px;display:flex;align-items:center;gap:14px">
        ...
        {{-- Ditolak / Dibatalkan --}}
        <div class="stat-card" style="background:#fff1f2;border:1px solid #fecdd3;border-radius:14px;padding:16px;display:flex;align-items:center;gap:14px">
    ...
    {{-- ── Filter & Search Bar ── --}}
    <div class="card" style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;padding:16px 20px;margin-bottom:20px">
    ...
    {{-- ── Main Table ── --}}
    <div class="table-card" style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;overflow:hidden">
                ...
                @forelse($lmList as $idx => $lap)
                    ...
                    <tr class="row-laporan-item" data-status="{{ $st }}" style="border-bottom:1px solid #f1f5f9;transition:background 0.15s">
                        ...
                        <td style="padding:14px 16px;font-size:13px">
                            ...
                            <button type="button" onclick="bukaDetailLaporan('{{ addslashes($lap->nama_pelapor) }}', '{{ addslashes($lap->role_pelapor) }}', '{{ addslashes($lap->judul) }}', '{{ addslashes($lap->isi_laporan) }}', '{{ $lap->created_at->format('d M Y, H:i') }} WIB')" style="background:none;border:none;color:#2563eb;font-size:11.5px;font-weight:700;cursor:pointer;padding:0;margin-top:4px">
