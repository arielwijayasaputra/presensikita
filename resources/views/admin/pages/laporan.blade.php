...
<div class="page-content page-anim" id="page-laporan" style="display:none"
    ...
    <div class="filter-bar" style="margin-bottom:18px;align-items:flex-end;gap:12px;flex-wrap:wrap">
        ...
        {{-- Tombol Export PDF --}}
        <button type="button" class="btn-secondary" onclick="exportLaporanPdf()" style="margin-left:auto;border-radius:10px;padding:10px 20px;font-size:13.5px;font-weight:600;border-radius:10px;display:inline-flex;align-items:center;gap:8px">
    ...
    <div class="stat-cards laporan-stat-cards" style="display:grid;grid-template-columns:repeat(6,1fr);gap:12px;margin-bottom:20px">
        {{-- Total Siswa --}}
        <div class="stat-card laporan-stat" style="background:#f0fdf4;border:1px solid #dcfce7;border-radius:var(--radius);padding:14px 16px;display:flex;align-items:center;gap:12px">
        ...
        {{-- Kehadiran --}}
        <div class="stat-card laporan-stat" style="background:#eff6ff;border:1px solid #dbeafe;border-radius:var(--radius);padding:14px 16px;display:flex;align-items:center;gap:12px">
        ...
        {{-- Sakit --}}
        <div class="stat-card laporan-stat" style="background:#fffbeb;border:1px solid #fef3c7;border-radius:var(--radius);padding:14px 16px;display:flex;align-items:center;gap:12px">
        ...
        {{-- Izin --}}
        <div class="stat-card laporan-stat" style="background:#f0f9ff;border:1px solid #e0f2fe;border-radius:var(--radius);padding:14px 16px;display:flex;align-items:center;gap:12px">
        ...
        {{-- Alpa --}}
        <div class="stat-card laporan-stat" style="background:#fff1f2;border:1px solid #fecdd3;border-radius:var(--radius);padding:14px 16px;display:flex;align-items:center;gap:12px">
        ...
        <div class="stat-card laporan-stat laporan-stat-ring" style="background:#fff;border:1px solid #e2e8f0;border-radius:var(--radius);padding:14px 16px;display:flex;align-items:center;gap:12px">
    ...
    <div class="charts-row laporan-charts-row" style="display:grid;grid-template-columns:1fr 1.2fr 1fr;gap:16px;margin-bottom:20px">
        {{-- Donut Chart --}}
        <div class="card" style="background:#fff;border-radius:var(--radius);border:1px solid #e2e8f0;padding:20px">
