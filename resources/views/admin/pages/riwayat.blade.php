...
<div class="page-content page-anim" id="page-riwayat" style="display:none">
    ...
    {{-- ── Ringkasan Rekap Kehadiran (Paling Atas) ── --}}
    <div style="margin-bottom:24px">
        ...
        <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:12px;align-items:center" id="riwayat-summary-grid">
            ...
            <div class="riwayat-summary-card" style="background:#fff;border:1px solid #e2e8f0;border-radius:var(--radius);padding:18px 20px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;box-shadow:var(--shadow)">
        ...
        <table id="riwayat-table">
            ...
            <tbody id="riwayat-tbody-page">
                ...
                <tr class="riwayat-row-item"
                    ...
                    <td style="text-align:center">
                        <button onclick="lihatDetailJurnal({{ $r->id_jurnal ?? 0 }}, '{{ $tglFormatted }}', '{{ $namaHari }}', '{{ htmlspecialchars($r->nama_kelas ?? '') }}', '{{ htmlspecialchars($r->materi ?? '') }}')"
