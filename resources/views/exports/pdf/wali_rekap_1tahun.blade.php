...
@section('title', 'Rekap Presensi 1 Tahun Ajaran - ' . ($namaKelas ?? 'Kelas'))

@section('content')
<div class="doc-header">
    <div class="doc-title">REKAPITULASI PRESENSI 1 TAHUN AJARAN</div>
    <div class="doc-subtitle">Tahun Ajaran: {{ $tahun }}/{{ $tahun + 1 }}</div>
</div>
...
<table class="meta-table">
    <tr>
        ...
        <td style="width: 32%">: 1 Tahun Penuh ({{ $tahun }}/{{ $tahun + 1 }})</td>
    </tr>
    <tr>
...
<table class="data-table">
    <thead>
        <tr>
            ...
            <th class="center" colspan="5" style="padding: 3px">Akumulasi Kehadiran (1 Tahun)</th>
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="11" class="center" style="padding: 20px; color: #94a3b8">Belum ada data akumulasi presensi untuk tahun ajaran ini.</td>
            </tr>
        @endforelse
    </tbody>
</table>
