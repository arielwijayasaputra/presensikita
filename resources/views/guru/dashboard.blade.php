    ...
    <header class="guru-header">
        ...
        <div class="guru-nav-right">
            ...
            <form method="POST" action="{{ route('logout') }}" style="margin:0" id="guru-logout-form">
                @csrf
                <button type="button" class="btn-admin-link" style="cursor:pointer;background:#fee2e2;border-color:#fecaca;color:#b91c1c;" onclick="confirmKeluar('guru-logout-form')">
