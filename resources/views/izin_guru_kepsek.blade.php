...
<head>
    ...
    <title>Persetujuan Izin Guru (Kepala Sekolah) - PresensiKita</title>
    ...
    <div class="box-body">
        ...
        <div class="decision">
            ...
            @if($izin->status_kepsek === 'menunggu')
                <form method="POST" action="{{ $approvalUrl }}" onsubmit="return konfirmasiKeputusan(event, 'Kepala Sekolah')">
                    @csrf
                    <div>
