...
<head>
    ...
    <title>Persetujuan Izin Guru (Waka) - PresensiKita</title>
...
<main class="box">
    <div class="box-header">
        ...
        <p class="intro">Halaman khusus Wakil Kepala Sekolah. Keputusan Anda langsung tercatat pada sistem.</p>
    </div>
    ...
    <div class="box-body">
        ...
        <div class="decision">
            <h2>Status &amp; Keputusan Waka</h2>
            <div class="row">
                <span class="label">Status Saat Ini</span>
                <span class="badge {{ $izin->status_waka === 'disetujui' ? 'badge-success' : ($izin->status_waka === 'ditolak' ? 'badge-danger' : 'badge-warning') }}" style="font-size:12.5px;padding:5px 12px">
                    {{ ucfirst($izin->status_waka) }}
                </span>
            </div>
            ...
            @if($izin->status_waka === 'menunggu')
                <form method="POST" action="{{ $approvalUrl }}" onsubmit="return konfirmasiKeputusan(event, 'Waka')">
                    @csrf
                    <div>
            ...
            @else
                <p class="intro" style="color:#64748b;margin-top:14px;font-style:italic">
                    Keputusan Waka telah diberikan dan tersimpan.
                </p>
            @endif
        </div>
    </div>
