<div class="page-content page-anim" id="page-guru-piket" style="display:block">
    <div class="greeting-row">
        ...
        <div class="header-date" style="background:#fff7ed;border-color:#fed7aa;color:#c2410c">
            ...
            <table class="data-table" style="min-width:760px">
                ...
                <tbody>
                    @forelse($jadwalHariIni as $jadwal)
                        <tr><td><span class="badge badge-info">{{ $jadwal->jam_ke }}</span></td><td>{{ substr($jadwal->jam_mulai, 0, 5) }} - {{ substr($jadwal->jam_selesai, 0, 5) }}</td><td><strong>{{ $jadwal->nama_kelas }}</strong></td><td>{{ $jadwal->nama_mapel }}</td><td>{{ $jadwal->nama_guru }}</td></tr>
                    @empty
    ...
    <div class="card" style="padding:22px 24px;margin-top:20px">
        <div class="card-header" style="margin-bottom:16px"><div class="card-title">Permintaan Izin Terbaru</div></div>
