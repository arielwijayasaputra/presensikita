<div class="page-content page-anim" id="page-waka-sdm" style="display:block">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:16px; margin-bottom:24px;">
        ...
        <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap">
            ...
            <!-- Tombol Export CSV -->
            <a href="{{ route('wakasdm.export', ['bulan' => $sdmBulan, 'tahun' => $sdmTahun]) }}" class="btn-secondary" style="display:inline-flex; align-items:center; gap:6px; padding:8px 14px; border-radius:10px; font-size:12.5px; font-weight:700; border:1px solid #cbd5e1; text-decoration:none">
