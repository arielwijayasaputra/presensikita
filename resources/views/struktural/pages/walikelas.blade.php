<div class="page-content page-anim" id="page-walikelas" style="display:block">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:16px; margin-bottom:24px;">
        ...
        <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap">
            ...
            <!-- Ekspor PDF -->
            <a href="{{ route('walikelas.export-pdf', ['bulan' => $waliBulan, 'tahun' => $waliTahun]) }}" class="btn-primary" style="display:inline-flex; align-items:center; gap:6px; padding:8px 14px; border-radius:10px; font-size:12.5px; font-weight:700; background:linear-gradient(135deg, #1e293b, #334155); text-decoration:none">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                <span>Ekspor PDF</span>
            </a>

            <!-- Ekspor CSV -->
            <a href="{{ route('walikelas.export', ['bulan' => $waliBulan, 'tahun' => $waliTahun]) }}" class="btn-secondary" style="display:inline-flex; align-items:center; gap:6px; padding:8px 14px; border-radius:10px; font-size:12.5px; font-weight:700; border:1px solid #cbd5e1; text-decoration:none">
